...
CLAIR3="/scratch/sc8781/Project/Clair3Proj/Clair3/clair3.py" # clair3.py
...
UNIFIED_VCF_FILE_PATH="/scratch/sc8781/Project/Data/HG001/GRCh38/UnificationOP/unified.vcf.gz"       # e.g. HG001.unified.vcf.gz
ALL_BAM_FILE_PATH="/scratch/sc8781/Project/Data/HG001/GRCh38/NA12878_GRCh38.bam"           # e.g. HG001.bam
DEPTHS="1000"                  # e.g. 1000 (means no subsample)
ALL_REFERENCE_FILE_PATH="/scratch/sc8781/Project/Data/HG001/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta"   # e.g. HG001.fasta
ALL_BED_FILE_PATH="/scratch/sc8781/Project/Data/HG001/GRCh38/HG002_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed"           # e.g. HG001.bed
ALL_SAMPLE="HG001"                    # e.g. HG001
OUTPUT_DIR="/scratch/sc8781/Project/Data/HG001/GRCh38/PreppedData"                   # e.g. output_folder
...
ALL_BAM_FILE_PATH=('/scratch/sc8781/Project/Data/HG001/GRCh38/NA12878_GRCh38.bam')
...
ALL_REFERENCE_FILE_PATH=('/scratch/sc8781/Project/Data/HG001/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta')

# Each line represents one BED region file for each sample
ALL_BED_FILE_PATH=('/scratch/sc8781/Project/Data/HG001/GRCh38/HG002_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed')

# Each line represents one representation-unified VCF file for each sample
UNIFIED_VCF_FILE_PATH=('/scratch/sc8781/Project/Data/HG001/GRCh38/UnificationOP/unified.vcf.gz')
...
MODEL_FOLDER_PATH="/scratch/sc8781/Project/Clair3Proj/train_HG001"
