...
UNIFIED_VCF_FILE_PATH="/scratch/sc8781/Project/Data/HG002/GRCh38/UnificationOP/unified.vcf.gz"       # e.g. hg002.unified.vcf.gz
ALL_BAM_FILE_PATH="/scratch/sc8781/Project/Data/HG002/GRCh38/NA24385_GRCh38.bam"           # e.g. hg002.bam
DEPTHS="1000"                  # e.g. 1000 (means no subsample)
ALL_REFERENCE_FILE_PATH="/scratch/sc8781/Project/Data/HG002/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta"   # e.g. hg002.fasta
ALL_BED_FILE_PATH="/scratch/sc8781/Project/Data/HG002/GRCh38/HG002_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed"           # e.g. hg002.bed
ALL_SAMPLE="HG002"                    # e.g. hg002
OUTPUT_DIR="/scratch/sc8781/Project/Data/HG002/GRCh38/PreppedData"                   # e.g. output_folder
...
ALL_BAM_FILE_PATH=('/scratch/sc8781/Project/Data/HG002/GRCh38/NA24385_GRCh38.bam')
...
ALL_REFERENCE_FILE_PATH=('/scratch/sc8781/Project/Data/HG002/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta')

# Each line represents one BED region file for each sample
ALL_BED_FILE_PATH=('/scratch/sc8781/Project/Data/HG002/GRCh38/HG002_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed')

# Each line represents one representation-unified VCF file for each sample
UNIFIED_VCF_FILE_PATH=('/scratch/sc8781/Project/Data/HG002/GRCh38/UnificationOP/unified.vcf.gz')
...
MODEL_FOLDER_PATH="/scratch/sc8781/Project/Clair3Proj/train_HG002"
