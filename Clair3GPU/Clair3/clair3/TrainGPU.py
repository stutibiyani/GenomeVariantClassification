...
class DataSequence(tf.keras.utils.Sequence):
    def __init__(self, data, chunk_list, param, tensor_shape, mini_epochs=1, add_indel_length=False, validation=False):
        ...
        self.batch_size = param.trainBatchSize * 4
...
def train_model(args):
    ...
    devices_names = [':'.join(d.name.split(":")[1:]) for d in devices]
    ...
    batch_size, chunk_size = param.trainBatchSize * 4, param.chunk_size
...
def main():
    ...
    parser.add_argument('--optimizer', default='sgd', help="Name of the optimizer to be used. Default is SGD.")

    parser.add_argument('--lrscheduler', default=None, help="Name of the LR scheduler. Default is None.")

    parser.add_argument('--num_gpus', default=1, help="Number of GPUs to use. Default is 1.")
