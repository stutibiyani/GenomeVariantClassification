...
def UnifyRepresentation(args):
    ...
    reference_sequence = reference_sequence_from(
        samtools_execute_command='/share/apps/samtools/1.14/intel/bin/samtools',
    ...
    if not len(rescue_dict):
        print("UnifyRepresentation::1362: Line returning!!!")
        return
    if output_vcf_fn is not None:
...
def main():
    ...
    parser.add_argument('--pypy', type=str, default="python3",
                        help=SUPPRESS)
