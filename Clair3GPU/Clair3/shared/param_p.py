...
support_platform = {'ont', 'hifi','ilmn', '10xg'}
min_af = 0.08
min_af_dict = {'ont':0.15, 'hifi':min_af, 'ilmn':min_af, '10xg':min_af}
...
max_depth = 144
max_depth_dict = {'ont':max_depth, 'hifi':max_depth, 'ilmn':max_depth, '10xg':max_depth}
