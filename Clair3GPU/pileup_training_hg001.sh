...
UNIFIED_VCF_FILE_PATH="/scratch/sb7580/Data/HG001/GRCh38/UnificationOP/unified.vcf.gz"       # e.g. hg001.unified.vcf.gz
ALL_BAM_FILE_PATH="/scratch/sb7580/Data/HG001/GRCh38/NA24385_GRCh38.bam"           # e.g. hg001.bam
DEPTHS="1000"                  # e.g. 1000 (means no subsample)
ALL_REFERENCE_FILE_PATH="/scratch/sb7580/Data/HG001/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta"   # e.g. hg001.fasta
ALL_BED_FILE_PATH="/scratch/sb7580/Data/HG001/GRCh38/HG001_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed"           # e.g. hg001.bed
ALL_SAMPLE="HG001"                    # e.g. hg001
OUTPUT_DIR="/scratch/sb7580/Data/HG001/GRCh38/PreppedData"                   # e.g. output_folder
...
ALL_BAM_FILE_PATH=('/scratch/sb7580/Data/HG001/GRCh38/NA12878_GRCh38.bam')
...
ALL_REFERENCE_FILE_PATH=('/scratch/sb7580/Data/HG001/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta')

# Each line represents one BED region file for each sample
ALL_BED_FILE_PATH=('/scratch/sb7580/Data/HG001/GRCh38/HG001_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.bed')

# Each line represents one representation-unified VCF file for each sample
UNIFIED_VCF_FILE_PATH=('/scratch/sb7580/Data/HG001/GRCh38/UnificationOP/unified.vcf.gz')
...
MODEL_FOLDER_PATH="/scratch/sb7580/HPMLProject/Clair3Proj/train_hg001_v100"
